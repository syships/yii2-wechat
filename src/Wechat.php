...
class Wechat extends Component
{
    ...
    private function token()
    {
        ...
        $httpClient = Yii::$app->wechatHttpClient->send($this->base_url."cgi-bin/token",$params);
    ...
    private function stableAccessToken($forceRefresh=false)
    {
        ...
        $httpClient = Yii::$app->wechatHttpClient->send($this->base_url."cgi-bin/stable_token",$params,'post');
